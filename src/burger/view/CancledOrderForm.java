 ...
 * @author sanda
 */
public class CancledOrderForm extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(CancledOrderForm.class.getName());
    
    
    public CancledOrderForm() throws IOException {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cancled Orders");
