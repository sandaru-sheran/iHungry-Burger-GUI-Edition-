...
public class PrepairingOrderForm extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(PrepairingOrderForm.class.getName());
    
    
    public PrepairingOrderForm() throws IOException {
        initComponents();
        BurgerController bc=new BurgerController();
        Burger [] burgerArray = bc.prepairingOrders();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Prepairing Orders");
