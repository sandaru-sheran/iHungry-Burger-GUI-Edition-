...
public class ProcessingOrdersForm extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(ProcessingOrdersForm.class.getName());

    /**
     * Creates new form SearchBestCustomer
     */
    public ProcessingOrdersForm() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jScrollPane2.setViewportView(processingOrderTable);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new ProcessingOrdersForm().setVisible(true));
    }
